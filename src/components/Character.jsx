...
export default function Character(props) {
    ...
    const { animations } = useFBX('/assets/animations/StandToSit.fbx');
    const idleAnimation = animations[0];
    idleAnimation.name = "idle";
    console.log(idleAnimation);

    // Add this after loading the model but before animations
    useEffect(() => {
        // Rename the bones to match animation
        if (nodes.Hips) {
            const armature = nodes.Hips;
            armature.traverse((obj) => {
                // Remove any 'Wolf3D_' prefix and add 'mixamorig' prefix
                if (obj.isBone) {
